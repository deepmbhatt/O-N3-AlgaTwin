...
const WATERFALL = [
  { label: 'Gross biological CO₂ capture', sub: 'Calculated from biomass growth rate data', value: 420, type: 'start' },
  ...
  { label: 'Biomass fate & permanence adjustment', sub: 'Weighted by destinations in the fate ledger', delta: -74, type: 'delta' },
  { label: 'Estimated net carbon removal', sub: 'Estimated net removal — pending third-party registry verification', value: 308, type: 'final' },
];
...
const LEDGER = [
  { date: '2026-09-08', pond: 'Pond 01', biomass: 180, dest: 'Biofuel', perm: 'longterm', permLabel: 'Long-term (~20 yr)' },
  { date: '2026-08-30', pond: 'Pond 02', biomass: 150, dest: 'Animal feed', perm: 'shortterm', permLabel: 'Short-term (~1 yr)' },
  { date: '2026-08-22', pond: 'Pond 03', biomass: 165, dest: 'Bioplastic', perm: 'longterm', permLabel: 'Long-term (~15 yr)' },
  { date: '2026-08-11', pond: 'Pond 01', biomass: 175, dest: 'Biochar', perm: 'permanent', permLabel: 'Permanent (100+ yr)' },
  { date: '2026-07-29', pond: 'Pond 02', biomass: 140, dest: 'Food', perm: 'shortterm', permLabel: 'Short-term (<1 yr)' },
];
...
export default function CarbonMRV() {
  ...
  return (
    <div className="page mrv-page">
      <header className="page-heading">
        <div>
          <span className="eyebrow">Carbon MRV</span>
          <h1>Carbon Measurement, Reporting &amp; Verification</h1>
          <p>How raw biological CO₂ uptake translates into estimated net carbon removal — with transparent confidence scoring.</p>
        </div>
      </header>
      ...
      {usingFallback && (
        <div className={`data-notice notice-${connection}`}>
          ...
          <p>Showing demonstration accounting records until registry integration is connected.</p>
        </div>
      )}
      ...
      <div className="mrv-grid">
        <div id="waterfall" className="glass" role="region" aria-label="Carbon accounting waterfall">
          ...
          <div className="wf-note">Accounting figures based on observed sensor and biomass growth trajectory.</div>
          <div id="wfRows">
            {WATERFALL.map((row, i) => {
            ...
            <div className="wf-disclaimer">
              This estimate demonstrates the MRV accounting calculation methodology. Final external credit issuance is subject to third-party verification.
            </div>
          </div>
        </div>
        ...
        <div id="confidence" className="glass" role="region" aria-label="Carbon confidence score">
          ...
          <div className="sub">Confidence factors weighted across sensor availability, satellite agreement, and data traceability.</div>
          <div className="gauge-wrap">
            <svg width="72" height="72" viewBox="0 0 72 72" aria-hidden="true">
              ...
              <circle
                ...
                strokeDashoffset={188.5 * (1 - OVERALL_CONFIDENCE / 100)}
                transform="rotate(-90 36 36)"
              />
            </svg>
            <div>
              <div className="gauge-big-val">{OVERALL_CONFIDENCE}%</div>
              <div className="gauge-big-label">overall confidence</div>
            </div>
          </div>
          <div id="factorRows">
            {FACTORS.map((f, i) => (
      ...
      <div id="ledger" className="glass" role="region" aria-label="Carbon fate ledger">
        ...
        <div className="sub">
          Carbon captured into algae biomass depends on destination permanence — whether utilized for biochar, bioplastics, or biofuels.
        </div>
